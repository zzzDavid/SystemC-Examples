...
#undef find_max
#define find_max find_max_wrapper_r
...
#include	"/work/shared/users/phd/nz264/systemc-examples/hierarchy/project/dut.cc"
...
void dut_wrapper::InitInstances( sc_int< 32 > _A[10], sc_int< 32 > _B[10], sc_int< 32 > _D[10] )
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    dut_cosim0->clk(clk);
		    dut_cosim0->rst(rst);
		    dut_cosim0->finish(finish);
		    dut_cosim0->find_max_x_out_busy(find_max_x_out.busy);
		    dut_cosim0->find_max_x_out_vld(find_max_x_out.vld);
		    dut_cosim0->find_max_x_out_data(find_max_x_out.data);
		    dut_cosim0->find_max_return_in_busy(find_max_return_in.busy);
		    dut_cosim0->find_max_return_in_vld(find_max_return_in.vld);
		    dut_cosim0->find_max_return_in_data(find_max_return_in.data);
		...
		case BDWRep_RTL_C:
		    ...
		    dut_rtl0->clk(clk);
		    dut_rtl0->rst(rst);
		    dut_rtl0->finish(finish);
		    dut_rtl0->find_max_x_out_busy(find_max_x_out.busy);
		    dut_rtl0->find_max_x_out_vld(find_max_x_out.vld);
		    dut_rtl0->find_max_x_out_data(find_max_x_out.data);
		    dut_rtl0->find_max_return_in_busy(find_max_return_in.busy);
		    dut_rtl0->find_max_return_in_vld(find_max_return_in.vld);
		    dut_rtl0->find_max_return_in_data(find_max_return_in.data);
		...
		case BDWRep_Behavioral:
		    dut0 = new dut( "dut", _A, _B, _D );

		    dut0->clk(clk);
		    dut0->rst(rst);
		    dut0->finish(finish);
		    dut0->find_max_x_out.busy(find_max_x_out.busy);
		    dut0->find_max_x_out.vld(find_max_x_out.vld);
		    dut0->find_max_x_out.data(find_max_x_out.data);
		    dut0->find_max_return_in.busy(find_max_return_in.busy);
		    dut0->find_max_return_in.vld(find_max_return_in.vld);
		    dut0->find_max_return_in.data(find_max_return_in.data);
...
void dut_wrapper_r::InitInstances()
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    dut_cosim0->rst(rst);
		    dut_cosim0->finish(finish);
		    dut_cosim0->find_max_x_out_busy(find_max_x_out_busy);
		    dut_cosim0->find_max_x_out_vld(find_max_x_out_vld);
		    dut_cosim0->find_max_x_out_data(find_max_x_out_data);
		    dut_cosim0->find_max_return_in_busy(find_max_return_in_busy);
		    dut_cosim0->find_max_return_in_vld(find_max_return_in_vld);
		    dut_cosim0->find_max_return_in_data(find_max_return_in_data);
		...
		case BDWRep_RTL_C:
		    ...
		    dut_rtl0->rst(rst);
		    dut_rtl0->finish(finish);
		    dut_rtl0->find_max_x_out_busy(find_max_x_out_busy);
		    dut_rtl0->find_max_x_out_vld(find_max_x_out_vld);
		    dut_rtl0->find_max_x_out_data(find_max_x_out_data);
		    dut_rtl0->find_max_return_in_busy(find_max_return_in_busy);
		    dut_rtl0->find_max_return_in_vld(find_max_return_in_vld);
		    dut_rtl0->find_max_return_in_data(find_max_return_in_data);
...
void dut_wrapper::InitInstances( sc_core::sc_module_name name, sc_int< 32 > _A[10], sc_int< 32 > _B[10], sc_int< 32 > _D[10] )
{
	dut0 = new dut( "dut", _A, _B, _D );
