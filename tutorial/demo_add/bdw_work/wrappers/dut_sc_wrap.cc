...
void dut_wrapper::InitInstances(  )
{
    ...
    dut0->clk(clk);
    dut0->rst(rst);
    dut0->din_1_busy(din_1.busy);
    dut0->din_1_vld(din_1.vld);
    dut0->din_1_data(din_1.data);
    dut0->din_2_busy(din_2.busy);
    dut0->din_2_vld(din_2.vld);
    dut0->din_2_data(din_2.data);
