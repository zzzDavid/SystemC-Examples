...
void dut_wrapper::InitInstances(  )
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    dut_cosim0->din_data(din.data);
		    dut_cosim0->dout_busy(dout.busy);
		    dut_cosim0->dout_vld(dout.vld);
		    dut_cosim0->dout_data(dout.data);
		    dut_cosim0->mem_WE0(mem.WE0);
		    dut_cosim0->mem_DIN0(mem.DIN0);
		    dut_cosim0->mem_DOUT0(mem.DOUT0);
		    dut_cosim0->mem_A0(mem.A0);
		    dut_cosim0->mem_REQ0(mem.REQ0);
        ...
        case BDWRep_CYC_HDL:
		    ...
		    dut_cycsim0->din_data(din.data);
		    dut_cycsim0->dout_busy(dout.busy);
		    dut_cycsim0->dout_vld(dout.vld);
		    dut_cycsim0->dout_data(dout.data);
		    dut_cycsim0->mem_WE0(mem.WE0);
		    dut_cycsim0->mem_DIN0(mem.DIN0);
		    dut_cycsim0->mem_DOUT0(mem.DOUT0);
		    dut_cycsim0->mem_A0(mem.A0);
		    dut_cycsim0->mem_REQ0(mem.REQ0);
		...
		case BDWRep_RTL_C:
		    ...
		    dut_rtl0->din_data(din.data);
		    dut_rtl0->dout_busy(dout.busy);
		    dut_rtl0->dout_vld(dout.vld);
		    dut_rtl0->dout_data(dout.data);
		    dut_rtl0->mem_WE0(mem.WE0);
		    dut_rtl0->mem_DIN0(mem.DIN0);
		    dut_rtl0->mem_DOUT0(mem.DOUT0);
		    dut_rtl0->mem_A0(mem.A0);
		    dut_rtl0->mem_REQ0(mem.REQ0);
		...
		case BDWRep_Behavioral:
		    ...
		    dut0->mem.WE0(mem.WE0);
		    dut0->mem.DIN0(mem.DIN0);
		    dut0->mem.DOUT0(mem.DOUT0);
		    dut0->mem.A0(mem.A0);
		    dut0->mem.REQ0(mem.REQ0);
...
void dut_wrapper_r::InitInstances()
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    dut_cosim0->din_data(din_data);
		    dut_cosim0->dout_busy(dout_busy);
		    dut_cosim0->dout_vld(dout_vld);
		    dut_cosim0->dout_data(dout_data);
		    dut_cosim0->mem_WE0(mem_WE0);
		    dut_cosim0->mem_DIN0(mem_DIN0);
		    dut_cosim0->mem_DOUT0(mem_DOUT0);
		    dut_cosim0->mem_A0(mem_A0);
		    dut_cosim0->mem_REQ0(mem_REQ0);
        ...
        case BDWRep_CYC_HDL:
		    ...
		    dut_cycsim0->din_data(din_data);
		    dut_cycsim0->dout_busy(dout_busy);
		    dut_cycsim0->dout_vld(dout_vld);
		    dut_cycsim0->dout_data(dout_data);
		    dut_cycsim0->mem_WE0(mem_WE0);
		    dut_cycsim0->mem_DIN0(mem_DIN0);
		    dut_cycsim0->mem_DOUT0(mem_DOUT0);
		    dut_cycsim0->mem_A0(mem_A0);
		    dut_cycsim0->mem_REQ0(mem_REQ0);
		...
		case BDWRep_RTL_C:
		    ...
		    dut_rtl0->din_data(din_data);
		    dut_rtl0->dout_busy(dout_busy);
		    dut_rtl0->dout_vld(dout_vld);
		    dut_rtl0->dout_data(dout_data);
		    dut_rtl0->mem_WE0(mem_WE0);
		    dut_rtl0->mem_DIN0(mem_DIN0);
		    dut_rtl0->mem_DOUT0(mem_DOUT0);
		    dut_rtl0->mem_A0(mem_A0);
		    dut_rtl0->mem_REQ0(mem_REQ0);
