...
# Simulation Options
#
use_verilog_simulator	ncverilog		;# 'mti', 'ncverilog', 'vcs', 'vcsi'
...
define_io_config	main	TLM
define_io_config	main	PIN
define_system_module	tb	tb.cc		;# SystemC module for simulation only
define_io_config	tb	TLM
define_io_config	tb	PIN
...
define_io_config	dut	TLM
define_io_config	dut	PIN
...
#
define_sim_config T	   {dut BEH}	      -io_config TLM	;# A behavioral TLM-level configuration
define_sim_config B	   {dut BEH}	      -io_config PIN	;# A behavioral PIN-level configuration
define_sim_config BASIC_V  {dut RTL_V BASIC}  -io_config PIN	;# RTL SystemC simulation
