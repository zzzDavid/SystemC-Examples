...
SC_MODULE( tb )
{
  public:
    ...
    // OLD
    cynw_p2p < input_t, CYN::TLM >::base_out dout; // data going in to the design
    cynw_p2p < output_t, CYN::TLM >::base_in din;  // data going out of the design
    // NEW
    //cynw_p2p < input_t, ioConfig >::base_out dout; // data going in to the design
    //cynw_p2p < output_t, ioConfig >::base_in din;  // data going out of the design
