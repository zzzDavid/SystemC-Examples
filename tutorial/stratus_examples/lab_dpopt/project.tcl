...
#
define_hls_config	dut	BASIC		;# A synthesis configuration of the "dut" HLS module
...
#
# Add Simulation and Logic Synthesis Configurations for all defined hls_configs
#
