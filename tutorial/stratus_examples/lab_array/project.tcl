...
# LAB EXERCISE: Add simConfigs for FLAT_NONE, FLAT_ALL, FLAT, REG, and MEM configs
# NEW
define_sim_config FLAT_V	{dut RTL_V FLAT}
define_sim_config REG_V	{dut RTL_V REG}
define_sim_config MEM_V	{dut RTL_V MEM}
