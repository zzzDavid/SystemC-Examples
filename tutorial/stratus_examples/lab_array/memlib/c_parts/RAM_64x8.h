...
#if defined(__GNUC__) 
    cynw_memory_if< sc_uint<6>, sc_uint<8> >* m_iface;

    void set_iface( cynw_memory_if< sc_uint<6>, sc_uint<8> >* iface ) {
        m_iface = iface;
    }
...
struct RAM_64x8_ext_signals_1
{
   ...
   HLS_SC_SIGNAL_DECL( sc_uint<6>, true ) A0;
  ...
  , public cynw_clk_rst_facade
{
  ...
  public:
    ...
    data_type get( const address_type& address )
    {
        HLS_DEFINE_FLOATING_PROTOCOL( 0.2000, 0.2000, 1, this, this->m_options|HLS::HLS_MEM_READ_FP|HLS::HLS_UNSTALLABLE_FP, address, "mem_read" );
    ...
    {
        HLS_DEFINE_FLOATING_PROTOCOL( 0.2000, 0.0, 1, this, this->m_options|HLS::HLS_MEM_WRITE_FP|HLS::HLS_USING_REG_EX_PORT, address, "mem_write" );
    ...
    public cynw_clk_rst
{
  ...
  public:
    ...
    data_type get( const address_type& address )
    {
        HLS_DEFINE_FLOATING_PROTOCOL( 0.2000, -1, 1, this, this->m_options|HLS::HLS_MEM_READ_FP, address, "mem_read" );
        HLS_SET_OUTPUT_OPTIONS(this->A0,ASYNC_POWER_HOLD);
        this->check_reset();
        cynw_scv_memory_tx< address_type, data_type > tx = this->tx_stream()->begin_read_tx( address );
        nb_get_start(address);
  ...
  public:
    ...
    void mux_inputs()
    {
       ...
       if ( (m_options & (HLS::HLS_USING_REG_PORT | HLS::HLS_USING_REG_EX_PORT)) == 0 ) {
            HLS_SET_OUTPUT_DELAY( m_port.WE0, 0.2000 );
            HLS_SET_OUTPUT_DELAY( m_port.DIN0, 0.2000 );
            HLS_SET_OUTPUT_DELAY( m_port.A0, 0.2000 );
            HLS_SET_OUTPUT_DELAY( m_port.REQ0, 0.2000 );
       }
        if (if1.REQ0) {
            m_port.WE0 = if1.WE0;
