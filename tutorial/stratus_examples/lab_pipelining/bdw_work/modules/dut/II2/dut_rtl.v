...
module dut(clk, rst, din_busy, din_vld, din_data_a, din_data_b, din_data_c, din_data_d, din_data_e, din_data_f, din_data_g, din_data_h, dout_busy, dout_vld, dout_data);
      ...
      reg cycle2_state;
      wire[31:0] dut_Mul_32Ux9U_32U_4_42_out1;
      wire[8:0] dut_Add_8Ux8U_9U_4_40_out1;
      reg[16:0] dut_Add_32Ux17U_33U_1_36_in1;
      reg[31:0] dut_Add_32Ux17U_33U_1_36_in2;
      wire[31:0] dut_Mul_32Ux9U_32U_4_35_out1;
      reg[7:0] dut_Mul_32Ux9U_32U_4_35_in1_slice;
      reg[28:0] dut_Mul_32Ux9U_32U_4_35_in2_slice;
      wire[15:0] dut_Mul_8Ux8U_16U_4_34_out1;
      reg[7:0] dut_Mul_8Ux8U_16U_4_34_in1;
      reg[7:0] dut_Mul_8Ux8U_16U_4_34_in2;
      ...
      reg[28:0] dut_Mul_32Ux10U_32U_4_32_in2_slice;
      reg gs_ctrl0;
      ...
      wire[32:0] dut_Add_32Ux17U_33U_1_36_out1;
      reg[16:0] s_reg_22;
      wire[63:0] dut_Mul_33Ux32U_64U_4_33_out1;
      reg[28:0] s_reg_21_slice11;
      ...
      reg stall0;
            ...
            if (rst == 1'b0) begin
               ...
               if (stall0) begin
                  ...
                  case (global_state) 
                     ...
                     2'd2: begin
                        if (!cycle4_state && s_reg_13) begin
               ...
               case (global_state) 
                  ...
                  2'd1: begin
                     if (cycle4_state) begin
                        ...
                        s_reg_13 <= s_reg_13_stage1;
                     end
                  end
                  
                  2'd2: begin
                     s_reg_13 <= dut_Or_1Ux1U_1U_4_6_out1;
                  end
         ...
         always @(posedge clk)
          begin :drive_s_reg_14
            if (stall0) begin
               ...
               s_reg_14 <= dut_N_Mux_8_2_0_4_19_out1;
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_15
            if (stall0) begin
               ...
               s_reg_15 <= dut_N_Mux_8_2_0_4_20_out1;
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_16
            if (stall0) begin
               ...
               s_reg_16 <= dut_N_Mux_8_2_0_4_21_out1;
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_17
            if (stall0) begin
               ...
               s_reg_17 <= dut_N_Mux_8_2_0_4_22_out1;
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_18
            if (stall0) begin
               ...
               s_reg_18 <= dut_N_Mux_8_2_0_4_23_out1;
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_19
            if (stall0) begin
               ...
               s_reg_19 <= dut_N_Mux_8_2_0_4_27_out1;
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_20
            if (stall0) begin
               ...
               s_reg_20 <= dut_N_Mux_8_2_0_4_28_out1;
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_21
            if (stall0) begin
               ...
               s_reg_21_slice11 <= dut_Mul_33Ux32U_64U_4_33_out1[28:0];
            end
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_22
            if (stall0) begin
               ...
               s_reg_22 <= dut_Add_32Ux17U_33U_1_36_out1[16:0];
            end
         end
         ...
         // resource: mux_29bx2i
         always @(dut_Add_9Ux8U_10U_4_30_out1 or gs_ctrl0 or s_reg_21_slice11)
          begin :drive_dut_Mul_32Ux10U_32U_4_32_in2
            if (gs_ctrl0) begin
               dut_Mul_32Ux10U_32U_4_32_in2_slice = {19'b0000000000000000000, dut_Add_9Ux8U_10U_4_30_out1};
            end
            else begin
               dut_Mul_32Ux10U_32U_4_32_in2_slice = s_reg_21_slice11;
            end
         end

         // resource: mux_10bx2i
         always @(dut_Add_9Ux8U_10U_4_29_out1 or dut_Add_8Ux8U_9U_4_39_out1 or gs_ctrl0)
          begin :drive_dut_Mul_32Ux10U_32U_4_32_in1
            if (gs_ctrl0) begin
               dut_Mul_32Ux10U_32U_4_32_in1 = dut_Add_9Ux8U_10U_4_29_out1;
            end
            else begin
               dut_Mul_32Ux10U_32U_4_32_in1 = {1'b0, dut_Add_8Ux8U_9U_4_39_out1};
            end
         end

         // resource: dut_Mul_32Ux10U_32U_4  instance: dut_Mul_32Ux10U_32U_4_32
         assign dut_Mul_32Ux10U_32U_4_32_out1 = {3'd0, dut_Mul_32Ux10U_32U_4_32_in2_slice}*{22'b0000000000000000000000, dut_Mul_32Ux10U_32U_4_32_in1};

         // resource: mux_33bx2i
         always @(dut_Mul_32Ux10U_32U_4_32_out1[19:0] or dut_Add_32Ux16U_33U_4_45_out1 or gs_ctrl0)
         ...
         // resource: mux_32bx2i
         always @(dut_Add_8Ux8U_9U_4_31_out1 or dut_Add_32Ux32U_32U_4_44_out1 or gs_ctrl0)
         ...
         // resource: mux_8bx2i
         always @(s_reg_19 or dut_N_Mux_8_2_0_4_23_out1 or gs_ctrl0)
          begin :drive_dut_Mul_8Ux8U_16U_4_34_in2
            if (gs_ctrl0) begin
               dut_Mul_8Ux8U_16U_4_34_in2 = dut_N_Mux_8_2_0_4_23_out1;
            end
            else begin
               dut_Mul_8Ux8U_16U_4_34_in2 = s_reg_19;
            end
         end

         // resource: mux_8bx2i
         always @(s_reg_20 or dut_N_Mux_8_2_0_4_21_out1 or gs_ctrl0)
          begin :drive_dut_Mul_8Ux8U_16U_4_34_in1
            if (gs_ctrl0) begin
               dut_Mul_8Ux8U_16U_4_34_in1 = dut_N_Mux_8_2_0_4_21_out1;
            end
            else begin
               dut_Mul_8Ux8U_16U_4_34_in1 = s_reg_20;
            end
         end

         // resource: dut_Mul_8Ux8U_16U_4  instance: dut_Mul_8Ux8U_16U_4_34
         assign dut_Mul_8Ux8U_16U_4_34_out1 = {8'b00000000, dut_Mul_8Ux8U_16U_4_34_in2}*{8'b00000000, dut_Mul_8Ux8U_16U_4_34_in1};

         // resource: mux_29bx2i
         always @(dut_N_Mux_8_2_0_4_19_out1 or gs_ctrl0 or s_reg_21_slice11)
          begin :drive_dut_Mul_32Ux9U_32U_4_35_in2
            if (gs_ctrl0) begin
               dut_Mul_32Ux9U_32U_4_35_in2_slice = {21'b000000000000000000000, dut_N_Mux_8_2_0_4_19_out1};
            end
            else begin
               dut_Mul_32Ux9U_32U_4_35_in2_slice = s_reg_21_slice11;
            end
         end

         // resource: mux_8bx2i
         always @(s_reg_17 or dut_N_Mux_8_2_0_4_20_out1 or gs_ctrl0)
          begin :drive_dut_Mul_32Ux9U_32U_4_35_in1
            if (gs_ctrl0) begin
               dut_Mul_32Ux9U_32U_4_35_in1_slice = dut_N_Mux_8_2_0_4_20_out1;
            end
            else begin
               dut_Mul_32Ux9U_32U_4_35_in1_slice = s_reg_17;
            end
         end

         // resource: dut_Mul_32Ux9U_32U_4  instance: dut_Mul_32Ux9U_32U_4_35
         assign dut_Mul_32Ux9U_32U_4_35_out1 = {3'd0, dut_Mul_32Ux9U_32U_4_35_in2_slice}*{24'd00000000, dut_Mul_32Ux9U_32U_4_35_in1_slice};

         // resource: mux_32bx2i
         always @(dut_Mul_32Ux9U_32U_4_35_out1 or gs_ctrl0)
          begin :drive_dut_Add_32Ux17U_33U_1_36_in2
            if (gs_ctrl0) begin
               dut_Add_32Ux17U_33U_1_36_in2 = {16'b0000000000000000, dut_Mul_32Ux9U_32U_4_35_out1[15:0]};
            end
            else begin
               dut_Add_32Ux17U_33U_1_36_in2 = dut_Mul_32Ux9U_32U_4_35_out1;
            end
         end

         // resource: mux_17bx2i
         always @(s_reg_22 or dut_Mul_8Ux8U_16U_4_34_out1 or gs_ctrl0)
          begin :drive_dut_Add_32Ux17U_33U_1_36_in1
            if (gs_ctrl0) begin
               dut_Add_32Ux17U_33U_1_36_in1 = {1'b0, dut_Mul_8Ux8U_16U_4_34_out1};
            end
            else begin
               dut_Add_32Ux17U_33U_1_36_in1 = s_reg_22;
            end
         end

         // resource: dut_Add_32Ux17U_33U_1  instance: dut_Add_32Ux17U_33U_1_36
         assign dut_Add_32Ux17U_33U_1_36_out1 = {1'b0, dut_Add_32Ux17U_33U_1_36_in2} + {16'b0000000000000000, dut_Add_32Ux17U_33U_1_36_in1};

         // resource: dut_Add_8Ux8U_9U_4  instance: dut_Add_8Ux8U_9U_4_39
         assign dut_Add_8Ux8U_9U_4_39_out1 = {1'b0, s_reg_16} + {1'b0, s_reg_18};

         // resource: dut_Add_8Ux8U_9U_4  instance: dut_Add_8Ux8U_9U_4_40
         assign dut_Add_8Ux8U_9U_4_40_out1 = {1'b0, s_reg_14} + {1'b0, s_reg_15};

         // resource: dut_Mul_32Ux9U_32U_4  instance: dut_Mul_32Ux9U_32U_4_42
         assign dut_Mul_32Ux9U_32U_4_42_out1 = dut_Add_32Ux17U_33U_1_36_out1[31:0]*{23'b00000000000000000000000, dut_Add_8Ux8U_9U_4_40_out1};

         // resource: dut_Add_32Ux32U_32U_4  instance: dut_Add_32Ux32U_32U_4_44
         assign dut_Add_32Ux32U_32U_4_44_out1 = dut_Mul_32Ux9U_32U_4_42_out1 + dut_Mul_32Ux10U_32U_4_32_out1;

         // resource: dut_Add_32Ux16U_33U_4  instance: dut_Add_32Ux16U_33U_4_45
         assign dut_Add_32Ux16U_33U_4_45_out1 = {1'b0, dut_Add_32Ux17U_33U_1_36_out1[31:0]} + {17'b00000000000000000, dut_Mul_8Ux8U_16U_4_34_out1};
               ...
               case (global_state) 
                  ...
                  2'd1: begin
                     if (cycle2_state) begin
                        ...
                        s_reg_21_stage1 <= dut_Mul_33Ux32U_64U_4_33_out1;
                     end
                  end
