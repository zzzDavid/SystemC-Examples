...
#endif
{
    ...
    void link_signals(const char *module_path, const char *sim_domain)
    {
		...
		esc_link_signals( &din_data_a, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &din_data_b, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &din_data_c, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &din_data_d, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &din_data_e, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &din_data_f, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &din_data_g, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &din_data_h, module_path, sim_domain, true, inputDelay );
