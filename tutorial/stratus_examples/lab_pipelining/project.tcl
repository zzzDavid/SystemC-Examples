...
# LAB EXERCISE: Add configurations for various intitation intervals
# NEW
#define_hls_config	dut	II1 -DII=1
#define_hls_config	dut	II2 -DII=2
#define_hls_config	dut	II3 -DII=3

#
# Add Simulation Configurations for all defined hls_configs
#
define_sim_config B	{dut BEH}

foreach hls_config_names [find -hls_config *] {
	set config_name [get_attr name $hls_config_names]
	if {$config_name!="PIN" && $config_name!="TLM"} {
		define_sim_config ${config_name}_V "dut RTL_V ${config_name}"
	}
}
######################################################################
