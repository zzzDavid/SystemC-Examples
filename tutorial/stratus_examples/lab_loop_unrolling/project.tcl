...
enable_waveform_logging	-vcd			;# Generate vcd, fsdb or shm waveform file with each simulation
...
define_sim_config UNROLL_FILL_V		{dut RTL_V UNROLL_FILL}
define_sim_config UNROLL_ALL_V		{dut RTL_V UNROLL_ALL}
define_sim_config FLAT_UNROLL_ALL_V	{dut RTL_V FLAT_UNROLL_ALL}
